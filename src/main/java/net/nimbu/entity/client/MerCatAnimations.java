...
public class MerCatAnimations {
     ...
     * @author Nimbu
     */
    public static final AnimationDefinition ANIM_MERCAT_SWIMMING = AnimationDefinition.Builder.withLength(2.0F).looping()
            ...
            .addAnimation("allTail", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("allTail2", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
